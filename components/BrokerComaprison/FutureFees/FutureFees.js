...
import AllFutureFeesCard from "./FutureFeesCard/AllFutureFeesCard";
...
const FutureFees = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch("https://backend.flagedu.com/api/company/future/fees/list/")
      .then((res) => res.json())
      .then((result) => {
        setIsLoading(false);
    ...
    <div>
      <div className="flex justify-between mt-10">
        <div className="flex items-center">
          ...
          />
          <p className="font-bold ml-2">Future Fees</p>
        </div>
